export function getCarForm(car = {}) {
  ...
  <form class="mb-3 col-12 bg-white p-3 mt-4" onsubmit="app.carsController.${car.id ? `updateCar('${car.id} ')` : 'createCar()'}">
    <h3> ${car.id ? 'Edit' + car.make : 'List a car'} List a Car </h3 >
                <div class="row">
                  ...
                  <div class="col-3 mb-2">
                    ...
                    <input required type="number" name="year" id="year" value="${car.year || ''}" value="2000" min="1960" max="2023"
                      class="form-control" placeholder="" aria-describedby="helpId">
                  </div>
                  <div class="col-3 mb-2">
                    <label for="" class="form-label">Price</label>
                    <input required type="number" name="price" id="price" value="${car.price || ''}" value="1" min="1" class="form-control"
                  ...
                  <div class="col-6">
                    ...
                    <input required type="color" name="color" id="color" value="${car.color || 'black'}" class="form-control" placeholder=""
                      aria-describedby="helpId">
                  </div>
                </div>
